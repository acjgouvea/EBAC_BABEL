...
var timeFutSp = ['santos', 'palmeiras', 'bragantino'];
var timeFutRj = ['vasco', 'botafogo', 'flamengo'];
// const timeFut = timeFutRj.concat.(timeFutSp);
var timeFut = [].concat(timeFutSp, timeFutRj);
console.log(timeFut);
var carroJulia = {
  modelo: 'gol',
  marca: 'vw',
...
var _timeFut = _toArray(timeFut),
  item1 = _timeFut[0],
  item2 = _timeFut[1],
  item3 = _timeFut[2],
  outrosTime = _timeFut.slice(3);